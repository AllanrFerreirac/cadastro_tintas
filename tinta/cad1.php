        ...
        <div class="row justify-content-center row-cols-2 row-cols-md-2 mb-3 text-justify">
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm">
                    ...
                    <div class="card-body">
                        <?php
                            echo "<b>Código Interno: </b>".$dados['codigo1']."<br/>";
                            echo "<b>Marca: </b>".$dados['marca']."<br/>";
                            echo "<b>Nomenclatura: </b>".$dados['nomenclatura']."<br/>";
                        ?>
                        <br/><br/>
                        <a href="cores.php"><button class="btn btn-outline-success">Voltar</button></a>
                    </div>
                </div>
            </div>
        </div>
