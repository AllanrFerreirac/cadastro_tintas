...
<html lang="pt=br">
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous"></script>
                ...
                <br/>
                    <div class="row justify-content-center row-cols-2 row-cols-md-1 mb-3 text-center">
                        <div class="col">
                            ...
                            <div class="card-body">
                            <form action="edita2.php?posicao=<?php echo $posicao; ?>" method="POST">
                                <div class="form-group">
                                    <label>Código Externo</label>
                                    <input type="number" class="form-control" name="codigo2" value="<?php echo $pessoa[$posicao]; ?>" required/>
                                    <br/>
                                    <label>Nome do Produto</label>
                                    <input type="text" class="form-control" name="produto" value="<?php echo $pessoa[$posicao+1]; ?>" required/>
                                    <br/>
                                    <label>Valor</label>
                                    <input type="number" class="form-control" name="valor" value="<?php echo $pessoa[$posicao+2]; ?>" required/>
                                    <br/>
        ...
        <footer>
            <hr/>
            <center><b>Formulário para Cadastro - Desenvolvida por Allan e Alisson</b></center>
        </footer>
    </body>
</html>