    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous"></script>
        <header>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light"></center>
                ...
                <div>
                     <center><a href="cores.php"><button type="button" class="btn btn-outline-dark"data-bs-toggle="modal" data-bs-target="#exampleModal">Cores</button></a> |
                    <a href="produtos.php"><button type="button" class="btn btn-outline-dark"data-bs-toggle="modal" data-bs-target="#exampleModal">Produtos</button></center></a> <!-- Colocar botão-->
                </div>    
            </nav>
        </header>
            <div class="container-fluid"> <!-- colocar sombreado e contorno-->
                <section>
                    <br/>
            ...
            <center><img src="imagens/cor.jpg" width="90%" height="90%"/></center>
        <footer>
            <hr/>
